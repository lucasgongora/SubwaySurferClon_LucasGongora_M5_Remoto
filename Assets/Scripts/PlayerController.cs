...
public class PlayerController : MonoBehaviour                                                             
{
    ...
    private bool swipeLet, swipeRight, swipeUp, swipeDown;
    ...
    {
        swipeLet = Input.GetKeyDown(KeyCode.LeftArrow);
    ...
    private void SetPlayePosition()
    {
        if (swipeLet && !IsRolling)
        {
